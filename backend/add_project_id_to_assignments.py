"""
Скрипт для добавления колонки project_id в таблицу assignments
"""
import asyncio
...
async def add_project_id_column():
    """Добавить колонку project_id в таблицу assignments"""
    try:
        async with engine.begin() as conn:
            ...
            """))
            print("✅ Колонка project_id успешно добавлена в таблицу assignments!")
