      ...
      changes: [
        {
          type: 'fixed',
          description:
            'Схемы контроля: перед блоком — section break (portrait), в конце — landscape на абзаце с картинкой; PNG масштабируется под лист с запасом под заголовок. DIAGNOSTICS теперь заполняет официальную форму ТО (правки по замечаниям PDF), а не старый программный генератор. APK 3.7.29+66.',
        },
      ],
    },
    {
      ...
      changes: [
        {
          type: 'fixed',
          description:
            'Схемы контроля в приложениях: страница переводится в landscape (sectPr на абзаце с картинкой), заголовок остаётся сверху, PNG масштабируется по ширине и высоте листа и не выходит за границы. APK 3.7.28+65.',
        },
      ],
    },
    {
      ...
      changes: [
        {
          type: 'fixed',
          description:
            'Отчёт ТО: в разделе 15 «Выводы» подставляются наименование, зав./рег./инв.№ оборудования (алиасы registration_number/factory_number); заголовок «Таблица №» и широкая таблица остаются на одном landscape-листе; приложение 8 — шрифт 12 pt; схемы контроля ВИК/УЗТ/ТК/УЗК/МПК выводятся на landscape в крупном размере. APK 3.7.27+64.',
        },
      ],
    },
    {
