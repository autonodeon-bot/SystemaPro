      ...
      <div className="bg-app-panel rounded-xl border border-app-line p-6">
        ...
        <div className="bg-green-500/10 border border-green-500/20 rounded-lg p-4 mb-6">
          ...
          <ul className="text-sm text-app-text2 space-y-1 ml-4">
            <li>• Заключение ЭПБ: приложение Б, протоколы №3–№6, приложение Е (остаточный ресурс)</li>
            <li>• Страница «Паспорт (прил. Б)» в чек-листе сосуда — таблицы Б1–Б6</li>
            <li>• Шаблон отстойника с 108 точками УЗТ и автоподбором при выборе оборудования</li>
            <li>• Твердометрия по точкам Т.1–Т.5, раздельный ввод МПК/УЗК для протоколов ЭПБ</li>
            <li>• Автосохранение чек-листа и восстановление черновика</li>
          </ul>
        </div>
