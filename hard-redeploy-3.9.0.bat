...
chcp 65001 >nul
echo ========================================
echo   ПОЛНАЯ ОЧИСТКА И ПЕРЕСБОРКА 3.9.0
echo ========================================
echo.
...
plink -batch -ssh -pw "%PASSWORD%" "%SERVER%" "docker exec es_td_ngo_frontend sh -c 'grep -r \"3.9.0\" /usr/share/nginx/html/*.html 2>/dev/null | head -2'"
